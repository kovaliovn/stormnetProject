 ...
 * чтобы в строке с выводом информации о самом крупном городе мира использовались статические переменные класса вместо
 ...
 * •	Для вывода информации о самом крупном городе должны использоваться статические переменные класса city и
 * population.
...
public class Method12 {
    ...
    public static void printCityPopulation(String city, double population) {
        ...
        System.out.println("В то время как в самом густонаселенном городе " + Method12.city + " население составляет "
                + Method12.population + " млн человек.");
    }
}
