 ...
 * •	Программа должна выводить на экран целое число - результат округления введенного целого числа, умноженного на
 * 3.6.
...
public class Variable12 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Скорость ветра в км/ч без округления: " + kilometersPerHours);
        System.out.println("Скорость ветра в км/ч после округления: " + Math.round(kilometersPerHours));
    }
}
