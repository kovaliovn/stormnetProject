...
/**
 * В классе List9 объявлены методы: copy(ArrayList<String>, ArrayList<String>), addAll(ArrayList<String>, String...),
 ...
 * Требования:
 * •	В классе List9 должен быть публичный статический метод copy(ArrayList<String>, ArrayList<String>) с типом
 * возвращаемого значения void.
 * •	В классе List9 должен быть публичный статический метод addAll(ArrayList<String>, String...) с типом
 * возвращаемого значения void.
 * •	В классе List9 должен быть публичный статический метод replaceAll(ArrayList<String>, String, String) с типом
 * возвращаемого значения void.
 ...
 * •	Метод replaceAll(ArrayList<String>, String, String) нужно переписать, используя метод replaceAll класса
 * Collections.
 */
