...
/**
 * Реализуй метод, который возвращает объект класса Pair. В поле x этого объекта должно содержаться минимальное число, а
 * в поле y - максимальное число из массива inputArray.
 * Требования:
