 ...
 * Требования:
 * •	Метод printRation(Animal animal) должен выводить "Любит мясо", если в качестве аргумента передан хищник
 * (Predator).
 * •	Метод printRation(Animal animal) должен выводить "Любит траву", если в качестве аргумента передано травоядное
 * (Herbivore).
 */
