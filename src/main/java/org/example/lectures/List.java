 ...
 * Требования:
 * •	Метод paySalary(String) должен добавлять в список alreadyGotSalaryEmployees имя сотрудника, если он есть в
 * списке
 * waitingEmployees.
 * •	Метод paySalary(String) должен заменять имя сотрудника на значение null, если он есть в списке
 * waitingEmployees.
 * •	Метод paySalary(String) не должен изменять списки waitingEmployees и alreadyGotSalaryEmployees, если
 * переданного
...
public class List {
    ...
    public static void setAlreadyGotSalaryEmployees() {
        waitingEmployees.add("Гунигерд");
        waitingEmployees.add("Боргелейф");
        waitingEmployees.add("Нифрод");
        waitingEmployees.add("Альбиуф");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Список waitingEmployees");
        for (String s : waitingEmployees) {
            System.out.println(s + ", ");
        }

        System.out.println();
        System.out.println("Список alreadyGotSalaryEmployees");
        for (String s : alreadyGotSalaryEmployees) {
            System.out.println(s + ", ");
        }
    }
